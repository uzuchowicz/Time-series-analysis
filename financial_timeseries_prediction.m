function [  ] = financial_timeseries_prediction( file_path , n_deleted )
...
close_data = fints(data_timestamps, data_close, {'OriginalCloseData'}, 1, 'Close Financial Time Series');

%plotting real data
chartfts(close_data) 

figure,
plot(close_data.OriginalCloseData)
grid on
